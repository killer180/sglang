...
class Scheduler(
    ...
    def get_next_batch_to_run(self) -> Optional[ScheduleBatch]:
        ...
        if ret is not None and self.server_args.enable_two_batch_overlap:
            ret = self.prepare_tbo_hetero(ret, self.server_args.two_batch_overlap_mode)
    ...
    @staticmethod
    def prepare_tbo_hetero(local_batch: ScheduleBatch, tbo_model: str):
        if local_batch.forward_mode.is_decode() and tbo_model == "hetero":
